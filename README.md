...
```bash
.venv/bin/python -m pytest -q           # 1,763 tests
```
...
tests/                  1,763 tests (conftest isolates the DB — see below)
```
...
`docs/REVIEW-FINDINGS-2026-08.md` is the August architecture review: 41 findings
